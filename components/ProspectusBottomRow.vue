<template>
    ...
    >
      <p v-if="arg === 'check-b'"><img src="../assets/img/sponsors/Custom/check-black.svg" alt="Checkmark" /></p>
      <p v-else-if="arg === 'check-w'"><img src="../assets/img/sponsors/Custom/check-white.svg" alt="Checkmark" /></p>
      <p v-else>{{ arg }}</p>
    </div>
  </template>
