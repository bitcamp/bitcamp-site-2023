    ...
    <div class="Question_Wrapper">
      <div class="Question_Column">
        <div class = "Question" v-for="(faq, i) in questions_left" :faq="faq" :key="i">
          <button @click="toggleButton(faq.question)" class="Question_Button" :class="{opened: faq.question === currentOpenedQuestion}">
            {{ faq.question }}
          </button>
          <div :class=" faq.question === currentOpenedQuestion ? 'Answer_Opened' : 'Answer'">
            {{ faq.answer }}
          </div>
        </div>
      </div>
...
const questions = ref<FAQ[]>([
  ...
  },
  {
    ...
    answer: "We'd love to get you on our volunteering or mentoring teams! If you'd like to help, please fill out our mentor form or our volunteer form. Also, be sure to follow us on Facebook and Twitter for updates!",
  },
  {
    question: "Teams",
  ...
  },
  {
    ...
    answer: "Any college student or high school student is more than welcome to apply to Bitcamp!",
  },
  {
  ...
  },
  {
    ...
    answer: "From Augmented Reality Human-Scale Pong to a research paper detailing vulnerabilities in Google's reCaptcha system, the projects at Bitcamp span across all categories and interests. You can check out all of the amazing submissions at the Bitcamp 2019 Devpost!", //ADD LINK
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, all attendees are required to wear a mask at all times except when eating and sleeping.",
  },
  {
...
const questions_right = questions.value.slice(questions.value.length / 2, questions.value.length)
